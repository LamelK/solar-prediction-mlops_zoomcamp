...
def test_retrain_flow(
    ...
    # Make new_data_df empty to simulate no new data key -> flow calls load_data_s3 only once
    ...
    assert mock_load_data.call_count == 1  # because new data empty, only baseline loaded
