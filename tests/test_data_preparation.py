...
from mlpipeline.data_preparation import load_and_prepare_data  # adjust import to your actual module name

# data
SAMPLE_CSV = """UNIXTime,Data,Time,Radiation,Temperature,Pressure,Humidity,WindDirection_Degrees,Speed,TimeSunRise,TimeSunSet
...
def mock_boto3_client():
    with patch("mlpipeline.data_preparation.boto3.Session") as mock_session_cls, \
         patch("mlpipeline.data_preparation.boto3.client") as mock_client_func:
...
def test_load_and_prepare_data_flow(mock_boto3_client):
    ...
    mock_boto3_client.get_object.assert_called_once_with(Bucket=bucket_name, Key=file_key)
    ...
    expected_columns = {
        ...
        "WindDirection_Degrees", "Speed",
        "Hour_sin", "Hour_cos", "Minute_sin", "Minute_cos",
        "Day_sin", "Day_cos", "Month_sin", "Month_cos",
        "Weekday_sin", "Weekday_cos",
        "MinutesSinceSunrise", "MinutesUntilSunset"
    }
